...
proto.server.ProductSearchResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.server.ProductSearchResponse.repeatedFields_, null);
};
...
proto.server.ProductSearchResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.server.Result.toObject, includeInstance)
  };
...
proto.server.ProductSearchResponse.prototype.getResultsList = function() {
  return /** @type{!Array<!proto.server.Result>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.server.Result, 5));
};
...
proto.server.Result.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.server.Index.toObject, includeInstance)
  };
...
proto.server.Result.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      reader.readMessage(value,proto.server.Index.deserializeBinaryFromReader);
...
proto.server.Result.prototype.getIndexesList = function() {
  return /** @type{!Array<!proto.server.Index>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.server.Index, 5));
};
...
proto.server.Result.prototype.addIndexes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.server.Index, opt_index);
};
